...
TRAIN_PATH = Path("data/splits/device_1_train_top20.csv")
TEST_PATH = Path("data/splits/device_1_test_top20.csv")
REPORT_DIR = Path("outputs/reports")
REPORT_PATH = REPORT_DIR / "device_1_random_forest_top20_smote.txt"
CONFUSION_MATRIX_PATH = REPORT_DIR / "device_1_random_forest_top20_smote_confusion_matrix.csv"
...
def main() -> None:
    ...
    print("Reading top20 train/test CSV files...")
    ...
    summary = f"""Device 1 Random Forest Top20 + SMOTE
=======================================
