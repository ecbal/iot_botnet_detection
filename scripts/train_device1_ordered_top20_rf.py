...
REPORT_PATH = REPORT_DIR / "device_1_ordered_random_forest_top20.txt"
CONFUSION_MATRIX_PATH = REPORT_DIR / "device_1_ordered_random_forest_top20_confusion_matrix.csv"
...
def main() -> None:
    ...
    print("Training Random Forest ordered top20...")
    ...
    summary = f"""Device 1 Ordered Random Forest Top20
====================================
