...
REPORT_PATH = REPORT_DIR / "device_1_knn_top20.txt"
CONFUSION_MATRIX_PATH = REPORT_DIR / "device_1_knn_top20_confusion_matrix.csv"
...
def main() -> None:
    ...
    print("Training KNN with top20 features...")
    ...
    summary = f"""Device 1 KNN Top20 Features
===========================
