...
REPORT_PATH = REPORT_DIR / "device_1_random_forest_top20.txt"
CONFUSION_MATRIX_PATH = REPORT_DIR / "device_1_random_forest_top20_confusion_matrix.csv"
...
def main() -> None:
    ...
    summary = f"""Device 1 Random Forest Top20 Features
======================================
